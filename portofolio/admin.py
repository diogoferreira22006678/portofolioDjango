...
from .models import Pessoa, Universidade, Curso, Professor, Cadeira, Projeto, Linguagem, Tecnologia, Aptidao, ExperienciaProfissional, TipoProjeto, TipoAptidao, TipoTecnologia, Escola, Interesse
